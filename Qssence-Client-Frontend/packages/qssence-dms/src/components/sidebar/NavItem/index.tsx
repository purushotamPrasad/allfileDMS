        ...
        >
          <ListItemStyled>
            <ListItemButton disabled={item.disabled} selected={active} sx={{justifyContent:"center"}}>
              <ListItemIcon sx={{ minWidth: `${collapseSidebar!==true?"36px":"auto"}`,justifyContent:`${collapseSidebar!==true?"left":"center"}` , p: "3px 0", color: "inherit" }}>
                {itemIcon}
              </ListItemIcon>
              ...
              {collapseSidebar!==true&&<ListItemIcon style={{ width: "20px", height: "20px", display: "flex", justifyContent: "end", color: "inherit", padding:"0px" }}>
                {active ? <IconChevronUp width={20} height={20} /> : <IconChevronDown width={20} height={20} />}
              </ListItemIcon>}
            </ListItemButton>
          </ListItemStyled>
        </List>
