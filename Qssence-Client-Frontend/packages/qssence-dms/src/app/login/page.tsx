...
const Login = () => {
  ...
  return (
    <PageContainer
      title="Login - Venturing Digitally Pvt Ltd User"
      description="Login - Venturing Digitally Pvt Ltd User Panel"
    >
      <Box sx={{ position: "relative", height: "100vh" }}>
        ...
        >
          ...
          <Card className="h-auto w-[80%] md:h-[70%] md:w-[70%]">
            <Grid
              container
              rowSpacing={1}
            ...
            >
              ...
              >
                <Box className="w-full h-full px-6 md:px-10 lg:px-16 xl:px-24 py-8 md:py-16">
                  ...
                  >
                    {/* Log in to Qssence */}
                    Log in to Venturing Digitally Pvt Ltd
                  </Typography>
                  <Typography
                    variant="h6"
                    sx={{
