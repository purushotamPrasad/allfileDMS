...
import AddWorkFlow from "@/components/workflow/dms-workflow/addWorkFlow/page";
...
const workflowOptions = [
  {
    ...
    content: <AddWorkFlow type="Global" setAlertHandler={setAlertHandler} setClose={setOpen} loadingData={function (value: boolean): void {
      throw new Error("Function not implemented.");
    } } />,
  },
  {
    title: "Create Region Workflow",
    content: <AddWorkFlow type="Region" setAlertHandler={setAlertHandler} setClose={setOpen} loadingData={function (value: boolean): void {
      throw new Error("Function not implemented.");
    } } />,
  },
  {
    title: "Create Local Workflow",
    content: <AddWorkFlow type="Local" setAlertHandler={setAlertHandler} setClose={setOpen} loadingData={function (value: boolean): void {
      throw new Error("Function not implemented.");
    } } />,
  },
];
...
//  onClick={handleClickOpen}
  ...
  return (
    ...
    />
         ...
         {showfield ? <AllDmsWorkflowDataList
