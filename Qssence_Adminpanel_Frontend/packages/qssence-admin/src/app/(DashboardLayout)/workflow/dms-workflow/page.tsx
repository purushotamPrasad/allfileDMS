...
const workflowOptions = [
  {
    ...
    content: <AddWorkFlow type="Global" setAlertHandler={setAlertHandler} setClose={setOpen} loadingData={setLoadingData} />,
  },
  {
    title: "Create Region Workflow",
    content: <AddWorkFlow type="Region" setAlertHandler={setAlertHandler}  setClose={setOpen} loadingData={setLoadingData}/>,
  },
  {
    title: "Create Local Workflow",
    content: <AddWorkFlow type="Local" setAlertHandler={setAlertHandler}  setClose={setOpen} loadingData={setLoadingData} />,
  },
];
