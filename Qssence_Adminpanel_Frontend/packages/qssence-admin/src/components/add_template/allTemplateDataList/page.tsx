...
import { CommonDataGridTemplate } from "qssence-common";
...
function AllTemplateDataList({ setTabData, open, setAlertHandler }: listProps) {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <IconFileText
          ...
          onClick={() => {
            console.log("Edit icon clicked for user:", params.row.userId);
          }}
        />
      ),
    },
...
export default AllTemplateDataList;
