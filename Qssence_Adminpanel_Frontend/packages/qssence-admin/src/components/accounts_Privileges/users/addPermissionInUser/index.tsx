...
function AddPermissionInUser({ open, setClose, setAlertHandler }: AddPermission) {
    ...
    const handleAdd = async () => {
        try {
            ...
            const response = await post<any>(`/permission/setPermissionForUser`, userdata, setAlertHandler);
            setAlertHandler({
                hasAlert: true,
...
export default AddPermissionInUser