...
function AddPermissionInGroup({ open, setOpen, setAlertHandler }: AddPermission) {
    ...
    const handleAdd = async () => {
        try {
            ...
            const response = await post<any>(`/permission/setPermissionForGroup`, userdata, setAlertHandler);
            setAlertHandler({
                hasAlert: true,
    ...
    const deleteApi = async (id: number) => {
        try {
            const response = await del(`/permission/deletePermissionById/${permissionData[id - 1]?.permissionId}`, {}, {}, setAlertHandler);
            setAlertHandler({
                hasAlert: true,
...
export default AddPermissionInGroup