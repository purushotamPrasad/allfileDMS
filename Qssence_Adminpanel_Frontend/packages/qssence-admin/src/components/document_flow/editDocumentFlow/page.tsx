...
function EditDocumentFlow({ setClose, setAlertHandler, view }: addPlantProps) {
  ...
  return (
    ...
    <Grid container spacing={3} style={{ display: "flex", alignItems: "center" }}>
      ...
      <Grid container spacing={3} style={{display:'flex', alignItems:'center', paddingTop:'18px'}}>
           <Grid item xs={12} md={view?12:6} sm={isSmScreen?12:view?12:6}>
         ...
         {view ? null : <Grid item xs={12} md={6} sm={isSmScreen?12:6} style={{display:"flex", gridColumnGap:"4px", height:'fit-content', alignItems:"center",paddingTop:"60px"}}>
...
export default EditDocumentFlow;