...
import EditDocumentFlow from "../../../../qssence-admin/src/components/document_flow/editDocumentFlow/page";
...
export default function CommonDataGridDocumentFlow({
  rowData,
  columnData,
  setSelectedRowArray,
  putApi,
  ...
  return (
    ...
    >
      ...
      />
          ...
          {open && (
                <CommonDialogPlants
                  buttonText={view?"View Document Flow":"Edit Document Flow"}
                  dialogTitle={view?"View Document Flow":"Edit Document Flow"}
                  dialogContent={
                    <EditDocumentFlow
                      setClose={setOpen}
