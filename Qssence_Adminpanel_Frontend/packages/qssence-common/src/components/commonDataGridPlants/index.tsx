...
import EditPlantsDepartment from "../../../../qssence-admin/src/components/plants_divisions/editPlantsDepartment/page";
import { useDispatch } from "react-redux";
import {ShowPlantData} from "../../../../qssence-admin/src/components/Redux/action"
...
export default function CommonDataGridPlants({
  rowData,
  columnData,
  setSelectedRowArray,
  putApi,
  ...
  return (
    ...
    >
      ...
      />
          {open && (
                <CommonDialogPlants
                  buttonText={view?"View Plants/Departments":"Edit Plants/Departments"}
                  dialogTitle={view?"View Plants/Departments":"Edit Plants/Departments"}
                  dialogContent={
                    <EditPlantsDepartment
                      setClose={setOpen}
