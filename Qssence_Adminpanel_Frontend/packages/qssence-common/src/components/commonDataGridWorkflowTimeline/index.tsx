...
import EditWorkflowTimeline from "../../../../qssence-admin/src/components/workflow/qms-workflow/editWorkflowTimeline/page";
...
export default function CommonDataGridWorkflowTimeline({
  rowData,
  columnData,
  setSelectedRowArray,
  putApi,
      ...
      />
          ...
          {open && (
                <CommonDialogWorkflow
                  dialogTitle={view?"View Workflow Timeline":"Edit Workflow Timeline"}
                  dialogContent={
                    <EditWorkflowTimeline
                      setClose={setOpen}
