...
const handleCompanyChange = async (event: SelectChangeEvent<string>) => {
  ...
  if (filteredCompanyPlanData.length === 0) {

     setAlertHandler({
          hasAlert: true,
          alertMessage: "First create plan for selected company!",
          alertType: "error",
          alertTitle: "Error",
      });
  ...
  setFormData({
    ...
    const handleSubmit=async ()=>
        {
          ...
          const updatedData = {
           ...
           purchaseCost: parseInt(formData.purchase_cost),
   ...
   <div style={{
          ...
          <h1 className="header_title primary_color">Create Software License</h1>
